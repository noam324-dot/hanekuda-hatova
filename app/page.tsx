...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const modeWasExplicitlyChosen = readStore("good-usage-mode-explicit", false);
  ...
  const changeUsageMode = (mode: UsageMode) => {
    ...
    try { localStorage.setItem("good-usage-mode-explicit", JSON.stringify(true)); } catch { /* נשמור בזיכרון לביקור הזה */ }
  };
